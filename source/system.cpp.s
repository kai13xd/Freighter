...
openFile__6SystemFPcbb:
	...
	# Stack Frame: 
	.set __sfsize,          0x011C
	.set __sf__old_sp,      0x0000   # size: 0x0004
	.set __sf__lr_reserved, 0x0004   # size: 0x0004
	.set __sf__full_path,   0x0008   # size: 0x0100
	.set __sf__stmw_addr,   0x0108   # size: 0x0014
...
#	bl           sprintf
#~~~[MINE]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# [line     ] DATABLUR_SOLUTION:
# [         ] sprintf( __sf__full_path, "%s%s", is_datadir ? "dataBlur/" : "", path );
# [line     ] if ( DVDConvertPathToEntrynum( __sf__full_path ) != -1 )
# [         ]   goto END:
# [         ]
# [line     ] DATADIR_SOLUTION:
# [         ] sprintf( __sf__full_path, "%s%s", is_datadir ? "dataDir/" : "", path );
# [         ]
# [         ] END:

#---[line     ]------------------------------------------------------------------
200$:  # DATABLUR_SOLUTION:
	mr           iArg3, path
	cmpwi        is_datadir, 0
	beq-         201$
	li_sda2      iArg2, datablur_str
	b            202$
201$:
	li_sda       iArg2, __noname__686
202$:
	li_sda2      iArg1, openfile_fmt_str
	addi         iArg0, sp, __sf__full_path
	crclr        6
	bl           sprintf
#---[line     ]------------------------------------------------------------------
	...
	bne-         206$ # END:
#---[line     ]------------------------------------------------------------------
203$: # DATADIR_SOLUTION:
	mr           iArg3, path
	cmpwi        is_datadir, 0
	beq-         204$
	li_sda2      iArg2, datadir_str
	b            205$
204$:
	li_sda       iArg2, __noname__686
205$:
